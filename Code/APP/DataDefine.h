        ...
        struct //READ ADDR 0-999
        {
            ...
            union //USER READ ADDR 500-999 用户只读寄存器
            {
                ...
                struct
                {
					...
					u32 StartSlowCnt;	//508 复位后启动慢速个数
                } Data;
            } User;
        } Read;
                ...
                struct
                {
					union//4000
					{
						...
						struct
						{
							...
							s32 SectionDlEn;	//4016	切片叠料检测启用
							u32 TrembleEn;		//4018  抖线启用
							s32 MaskSpeed;      //4020  大片速度
						}Data;
					}Config;
					...
					union//4100
					{
						...
						struct
						{
							...
							u32 DelayPress;			//4148	拉线电机走到拉线后位置后延时压带
							u32 SectionDelay;		//4150	切片机叠料延时
							u32 DelayPull;			//4152	取线到位延时
						}Data;
					}Delay;
					...
					union//4200
					{
						...
						struct
						{
							...
							float PullBack_2;		//4238	拉线2回退位
							float PullTake_2;		//4240	拉线2取线位
						}Data;
					}Position;
